...
public struct MacFlareSettings: Codable {
    ...
    // Saved instantly (like the web app's localStorage library) — deliberately
    // NOT part of applyFxFields, so closing without Apply & Save keeps it.
    public var customFxPresets: [String] = []
    ...
    public init(from decoder: Decoder) throws {
        ...
        customFxPresets = try c.decodeIfPresent([String].self, forKey: .customFxPresets) ?? d.customFxPresets
    }
